...
<h1 className="mobile:text-[12px] text-white rounded-full bg-black px-3 py-3 font-bold cursor-pointer hover:text-blue-300 bg-opacity-80 laptop:text-[20px] laptop:px-6">
      About
  </h1>
</Link>
